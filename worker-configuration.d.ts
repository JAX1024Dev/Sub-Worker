/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6ff14f01f1bcf2a3334510765c6f1b8)
// Runtime types generated with workerd@1.20260908.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	SING_BOX_CONFIG_MANIFEST_URL: "https://raw.githubusercontent.com/JAX1024Dev/Sub-Worker/main/example/sing-box/channels/staging.json" | "https://raw.githubusercontent.com/JAX1024Dev/Sub-Worker/main/example/sing-box/channels/production.json";
	THREE_X_UI_SUB_BASE_URL: string;
	LIVE_TEST_SUBSCRIPTION_ID: string;
	STAGING_WORKER_BASE_URL: string;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		SING_BOX_CONFIG_MANIFEST_URL: "https://raw.githubusercontent.com/JAX1024Dev/Sub-Worker/main/example/sing-box/channels/production.json";
		THREE_X_UI_SUB_BASE_URL: string;
		LIVE_TEST_SUBSCRIPTION_ID: string;
		STAGING_WORKER_BASE_URL: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SING_BOX_CONFIG_MANIFEST_URL" | "THREE_X_UI_SUB_BASE_URL" | "LIVE_TEST_SUBSCRIPTION_ID" | "STAGING_WORKER_BASE_URL">> {}
}
